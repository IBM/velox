...
class HivePartitionFunctionTest : public ::testing::Test,
 ...
 protected:
  ...
  void assertPartitions(
    ...
    connector::hiveV2::HivePartitionFunction partitionFunction(
  ...
  void assertPartitionsWithConstChannel(
    ...
    connector::hiveV2::HivePartitionFunction partitionFunctionNorm(
    ...
    connector::hiveV2::HivePartitionFunction partitionFunctionConst(
...
TEST_F(HivePartitionFunctionTest, spec) {
  ...
  {
    auto hiveSpec =
        std::make_unique<connector::hiveV2::HivePartitionFunctionSpec>(
            bucketCount,
            bucketToPartition,
    ...
    auto copy = connector::hiveV2::HivePartitionFunctionSpec::deserialize(
        serialized, pool());
...
TEST_F(HivePartitionFunctionTest, function) {
  ...
  auto hiveFunctionWithoutPartitionMap =
      std::make_unique<connector::hiveV2::HivePartitionFunction>(
          bucketCount,
          std::vector<column_index_t>{0, 1, 2},
          std::vector<VectorPtr>{});
...
TEST_F(HivePartitionFunctionTest, skew) {
  ...
  ASSERT_NE(
      static_cast<connector::hiveV2::HivePartitionFunction*>(
