...
class HiveConnector : public Connector {
 ...
 hive_common::FileHandleCacheStats fileHandleCacheStats() {
 ...
 hive_common::FileHandleCacheStats clearFileHandleCache() {
    return fileHandleFactory_.clearCache();
  }

 private:
  const std::shared_ptr<HiveConfig> hiveConfig_;
  hive_common::FileHandleFactory fileHandleFactory_;
