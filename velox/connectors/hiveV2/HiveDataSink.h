...
template <>
struct fmt::formatter<facebook::velox::connector::hiveV2::HiveDataSink::State>
   : formatter<std::string> {
 auto format(
     facebook::velox::connector::hiveV2::HiveDataSink::State s,
     format_context& ctx) const {
   return formatter<std::string>::format(
       facebook::velox::connector::hiveV2::HiveDataSink::stateString(s), ctx);
 }
};

template <>
struct fmt::formatter<
   facebook::velox::connector::hiveV2::LocationHandle::TableType>
   : formatter<int> {
 auto format(
     facebook::velox::connector::hiveV2::LocationHandle::TableType s,
     format_context& ctx) const {
