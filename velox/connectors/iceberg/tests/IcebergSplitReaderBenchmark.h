...
class IcebergSplitReaderBenchmark {
 public:
  ...
  int read(
      ...
      uint32_t nextSize,
      std::unique_ptr<connector::iceberg::IcebergSplitReader>
          icebergSplitReader);
  ...
  std::vector<std::shared_ptr<connector::IcebergConnectorSplit>>
  ...
  std::shared_ptr<connector::IcebergConnectorSplit> makeIcebergSplit(
      const std::string& dataFilePath,
      const std::vector<connector::iceberg::IcebergDeleteFile>&
          deleteFiles = {});
