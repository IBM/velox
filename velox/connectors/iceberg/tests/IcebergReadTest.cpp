...
#include "velox/connectors/iceberg/IcebergMetadataColumns.h"
...
class IcebergReadTest : public IcebergConnectorTestBase {
 public:
  ...
  void assertPositionalDeletes(
    ...
    auto task = IcebergConnectorTestBase::assertQuery(
...
TEST_F(IcebergReadTest, testPartitionedRead) {
  ...
  IcebergConnectorTestBase::assertQuery(plan, splits, "SELECT 1, '2018-04-07'");
  ...
  IcebergConnectorTestBase::assertQuery(plan, splits, "SELECT 0, '2018-04-06'");
}
