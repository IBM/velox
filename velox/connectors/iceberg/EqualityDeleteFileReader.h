...
using SubfieldFilters =
    std::unordered_map<velox::common::Subfield, std::unique_ptr<common::Filter>>;
...
class EqualityDeleteFileReader {
 ...
 private:
  ...
  hive_common::FileHandleFactory* const fileHandleFactory_;
  memory::MemoryPool* const pool_;

  // The split of the equality delete file to be processed by the delete file
  // RowReader.
  std::shared_ptr<const hive_common::ConnectorSplitBase> deleteSplit_;
