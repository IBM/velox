...
//
//  TestValue::adjust(
//      "facebook::velox::connector::iceberg::IcebergDataSource::next", this);
//
...
std::shared_ptr<velox::common::ScanSpec> IcebergDataSource::makeScanSpec() {
  auto spec = hive_common::ConnectorDataSource::makeScanSpec();
...
vector_size_t IcebergDataSource::evaluatePartitionFilter(
