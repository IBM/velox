...
//      const int32_t numPrefetchSplit);
  ...
  static std::shared_ptr<hive_common::ColumnHandleBase> regularColumn(
      const std::string& name,
      const TypePtr& type);

  static std::shared_ptr<connector::hive_common::ColumnHandleBase> partitionKey(
      const std::string& name,
      const TypePtr& type);

  static std::shared_ptr<connector::hive_common::ColumnHandleBase>
...
//     : public connector::hive_common::ConnectorSplitBaseBuilder {
//  public:
//   explicit HiveConnectorSplitBuilder(std::string filePath)
//       : connector::hive_common::ConnectorSplitBaseBuilder(filePath) {
