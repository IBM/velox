...
class SplitReader {
 ...
 protected:
  /// Create the dwio::hive_common::Reader object baseReader_, which will be
  ...
  /// Create the dwio::hive_common::RowReader object baseRowReader_, which owns
  ...
  const std::shared_ptr<const ConnectorConfig> connectorConfig_;
