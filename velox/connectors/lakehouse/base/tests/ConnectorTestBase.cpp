...
//
//std::unique_ptr<base::ColumnHandleBase>
...
//           std::make_shared<base::ColumnHandleBase>(
...
//std::shared_ptr<base::ColumnHandleBase> ConnectorTestBase::regularColumn(
//    const std::string& name,
//    const TypePtr& type) {
//  return std::make_shared<base::ColumnHandleBase>(
//      name, base::ColumnHandleBase::ColumnType::kRegular, type);
//}

//std::shared_ptr<base::ColumnHandleBase>
...
std::shared_ptr<base::ColumnHandleBase> ConnectorTestBase::partitionKey(
    const std::string& name,
    const TypePtr& type) {
  return std::make_shared<base::ColumnHandleBase>(
      name,
