...
#include "velox/connectors/lakehouse/base/FileProperties.h"
...
struct HiveConnectorSplit : public base::ConnectorSplitBase {
...
class HiveConnectorSplitBuilder
    : public base::ConnectorSplitBuilder<HiveConnectorSplitBuilder> {
 public:
  HiveConnectorSplitBuilder(std::string filePath)
      : ConnectorSplitBuilder{std::move(filePath)} {}
