...
#include "velox/connectors/lakehouse/hiveV2/HiveConnector.h"
#include "velox/connectors/lakehouse/hiveV2/HiveConnectorSplit.h"
#include "velox/connectors/lakehouse/hiveV2/HiveDataSink.h"
...
class HiveConnectorTestBase : public exec::test::OperatorTestBase {
 public:
  ...
  static std::shared_ptr<connector::lakehouse::hive::HiveConnectorSplit>
  ...
  static std::shared_ptr<connector::lakehouse::hive::HiveTableHandle>
  makeHiveTableHandle(
      ...
      const std::unordered_map<std::string, std::string>& tableParameters =
          {}) {
    return std::make_shared<connector::lakehouse::hive::HiveTableHandle>(
        kHiveConnectorId,
        tableName,
  ...
  static std::unique_ptr<connector::lakehouse::hive::HiveColumnHandle>
  ...
  static std::shared_ptr<connector::lakehouse::hive::LocationHandle>
  makeHiveLocationHandle(
      std::string targetDirectory,
      std::optional<std::string> writeDirectory = std::nullopt,
      connector::lakehouse::hive::LocationHandle::TableType tableType =
          connector::lakehouse::hive::LocationHandle::TableType::kNew) {
    return std::make_shared<connector::lakehouse::hive::LocationHandle>(
  ...
  static std::shared_ptr<connector::lakehouse::hive::HiveInsertTableHandle>
  makeHiveInsertTableHandle(
      const std::vector<std::string>& tableColumnNames,
      const std::vector<TypePtr>& tableColumnTypes,
      const std::vector<std::string>& partitionedBy,
      std::shared_ptr<connector::lakehouse::hive::HiveBucketProperty>
          bucketProperty,
      std::shared_ptr<connector::lakehouse::hive::LocationHandle>
          locationHandle,
  ...
  static std::shared_ptr<connector::lakehouse::hive::HiveColumnHandle>
  regularColumn(const std::string& name, const TypePtr& type);

  static std::shared_ptr<connector::lakehouse::hive::HiveColumnHandle>
  partitionKey(const std::string& name, const TypePtr& type);
...
/// Same as connector::lakehouse::hive::HiveConnectorBuilder, except that this
/// defaults connectorId to kHiveConnectorId.
class HiveConnectorSplitBuilder
    : public connector::lakehouse::hive::HiveConnectorSplitBuilder {
 public:
  explicit HiveConnectorSplitBuilder(std::string filePath)
      : connector::lakehouse::hive::HiveConnectorSplitBuilder(filePath) {
