...
#include "HiveConnectorTestBase.h"
...
TEST_F(HiveConnectorSerDeTest, hiveColumnHandle) {
  ...
  auto columnHandleTypes = {
      ...
      HiveColumnHandle::ColumnType::kHiveRowIndex,
  };

  for (auto columnHandleType : columnHandleTypes) {
    auto columnHandle = makeHiveColumnHandle(
        "columnHandle",
        columnType,
        columnType,
...
TEST_F(HiveConnectorSerDeTest, locationHandle) {
  auto locationHandle = makeHiveLocationHandle(
      "targetDirectory",
...
TEST_F(HiveConnectorSerDeTest, hiveInsertTableHandle) {
  ...
  auto hiveInsertTableHandle = HiveConnectorTestBase::makeHiveInsertTableHandle(
      tableColumnNames,
      tableColumnTypes,
      {"loc"},
      bucketProperty,
