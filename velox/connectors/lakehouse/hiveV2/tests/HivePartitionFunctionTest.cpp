...
class HivePartitionFunctionTest : public ::testing::Test,
 ...
 protected:
  ...
  void assertPartitions(
    ...
    connector::lakehouse::hive::HivePartitionFunction partitionFunction(
  ...
  void assertPartitionsWithConstChannel(
    ...
    connector::lakehouse::hive::HivePartitionFunction partitionFunctionNorm(
    ...
    connector::lakehouse::hive::HivePartitionFunction partitionFunctionConst(
...
TEST_F(HivePartitionFunctionTest, spec) {
  ...
  {
    auto hiveSpec =
        std::make_unique<connector::lakehouse::hive::HivePartitionFunctionSpec>(
            bucketCount,
            bucketToPartition,
    ...
    auto copy = connector::lakehouse::hive::HivePartitionFunctionSpec::deserialize(
        serialized, pool());
...
TEST_F(HivePartitionFunctionTest, function) {
  ...
  auto hiveFunctionWithoutPartitionMap =
      std::make_unique<connector::lakehouse::hive::HivePartitionFunction>(
          bucketCount,
          std::vector<column_index_t>{0, 1, 2},
          std::vector<VectorPtr>{});
...
TEST_F(HivePartitionFunctionTest, skew) {
  ...
  ASSERT_NE(
      static_cast<connector::lakehouse::hive::HivePartitionFunction*>(
