...
#include "velox/connectors/lakehouse/hiveV2/tests/HiveConnectorTestBase.h"
...
namespace facebook::velox::connector::lakehouse::hive::test {
...
void HiveConnectorTestBase::SetUp() {
  ...
  connector::registerConnectorFactory(
      std::make_shared<connector::lakehouse::hive::HiveConnectorFactory>());
  auto hiveConnector =
      connector::getConnectorFactory(
          connector::lakehouse::hive::HiveConnectorFactory::kHiveConnectorName)
          ->newConnector(
              kHiveConnectorId,
...
std::vector<std::shared_ptr<exec::test::TempFilePath>> HiveConnectorTestBase::makeFilePaths(
    int count) {
...
std::vector<std::shared_ptr<connector::lakehouse::hive::HiveConnectorSplit>>
HiveConnectorTestBase::makeHiveConnectorSplits(
  ...
  std::vector<std::shared_ptr<connector::lakehouse::hive::HiveConnectorSplit>> splits;
  // Add all the splits.
...
std::unique_ptr<connector::lakehouse::hive::HiveColumnHandle>
...
HiveConnectorTestBase::makeHiveColumnHandle(
    ...
    const std::vector<std::string>& requiredSubfields,
    connector::lakehouse::hive::HiveColumnHandle::ColumnType columnType) {
  ...
  return std::make_unique<connector::lakehouse::hive::HiveColumnHandle>(
...
std::shared_ptr<connector::lakehouse::hive::HiveConnectorSplit>
...
// static
std::shared_ptr<connector::lakehouse::hive::HiveInsertTableHandle>
HiveConnectorTestBase::makeHiveInsertTableHandle(
    const std::vector<std::string>& tableColumnNames,
    const std::vector<TypePtr>& tableColumnTypes,
    const std::vector<std::string>& partitionedBy,
    std::shared_ptr<connector::lakehouse::hive::LocationHandle> locationHandle,
...
HiveConnectorTestBase::makeHiveInsertTableHandle(
    ...
    const std::vector<TypePtr>& tableColumnTypes,
    const std::vector<std::string>& partitionedBy,
    std::shared_ptr<connector::lakehouse::hive::HiveBucketProperty> bucketProperty,
    std::shared_ptr<connector::lakehouse::hive::LocationHandle> locationHandle,
    const dwio::common::FileFormat tableStorageFormat,
    const std::optional<common::CompressionKind> compressionKind,
    ...
    const std::shared_ptr<dwio::common::WriterOptions>& writerOptions,
    const bool ensureFiles) {
  std::vector<std::shared_ptr<const connector::lakehouse::hive::HiveColumnHandle>>
      columnHandles;
  std::vector<std::string> bucketedBy;
  std::vector<TypePtr> bucketedTypes;
  std::vector<std::shared_ptr<const connector::lakehouse::hive::HiveSortingColumn>>
      sortedBy;
  ...
  for (int i = 0; i < tableColumnNames.size(); ++i) {
    ...
    if (std::find(
      ...
      columnHandles.push_back(
          std::make_shared<connector::lakehouse::hive::HiveColumnHandle>(
              tableColumnNames.at(i),
              connector::lakehouse::hive::HiveColumnHandle::ColumnType::kPartitionKey,
      ...
      columnHandles.push_back(
          std::make_shared<connector::lakehouse::hive::HiveColumnHandle>(
              tableColumnNames.at(i),
              connector::lakehouse::hive::HiveColumnHandle::ColumnType::kRegular,
              tableColumnTypes.at(i),
              tableColumnTypes.at(i)));
    }
  }
  ...
  return std::make_shared<connector::lakehouse::hive::HiveInsertTableHandle>(
      columnHandles,
      locationHandle,
      tableStorageFormat,
      bucketProperty,
...
std::shared_ptr<connector::lakehouse::hive::HiveColumnHandle>
HiveConnectorTestBase::regularColumn(
    const std::string& name,
    const TypePtr& type) {
  return std::make_shared<connector::lakehouse::hive::HiveColumnHandle>(
      name,
      connector::lakehouse::hive::HiveColumnHandle::ColumnType::kRegular,
      type,
      type);
...
HiveConnectorTestBase::synthesizedColumn(
  ...
  return std::make_shared<connector::lakehouse::hive::HiveColumnHandle>(
      name,
      connector::lakehouse::hive::HiveColumnHandle::ColumnType::kSynthesized,
      type,
      type);
}
