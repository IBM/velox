...
#include "HiveTableHandle.h"
#include "PartitionIdGenerator.h"
...
template <>
struct fmt::formatter<facebook::velox::connector::lakehouse::hive::HiveDataSink::State>
   : formatter<std::string> {
 auto format(
     facebook::velox::connector::lakehouse::hive::HiveDataSink::State s,
     format_context& ctx) const {
   return formatter<std::string>::format(
       facebook::velox::connector::lakehouse::hive::HiveDataSink::stateString(s), ctx);
 }
};

template <>
struct fmt::formatter<
   facebook::velox::connector::lakehouse::hive::LocationHandle::TableType>
   : formatter<int> {
 auto format(
     facebook::velox::connector::lakehouse::hive::LocationHandle::TableType s,
     format_context& ctx) const {
