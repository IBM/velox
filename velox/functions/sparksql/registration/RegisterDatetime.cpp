...
void registerDatetimeFunctions(const std::string& prefix) {
  ...
  registerFunction<ParameterBinder<HourFunction, Timestamp>, int32_t, Timestamp>(
      {prefix + "hour"});
  registerFunction<ParameterBinder<HourFunction, TimestampUtc>, int32_t, TimestampUtc>(
      {prefix + "hour"});
