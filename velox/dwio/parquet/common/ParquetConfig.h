...
class ParquetConfig {
 public:
  ...
  VELOX_PARQUET_CONFIG(
      kNullStructForMissingFieldsSession,
      kNullStructForMissingFields,
      nullStructForMissingFields,
      "null_struct_for_missing_fields",
      "null-struct-for-missing-fields",
      bool,
      false,
  ...
  static void registerProperties(
    ...
    registerProperty<kAllowInt32NarrowingSessionProperty>(
        properties, sessionPrefix);
    registerProperty<kNullStructForMissingFieldsSessionProperty>(
        properties, sessionPrefix);
